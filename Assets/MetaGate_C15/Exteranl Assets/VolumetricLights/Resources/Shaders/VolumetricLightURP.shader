	...
	Properties
	{
		...
		SubShader
		{
			...
			Pass
			{
                ...
                #pragma multi_compile_local_fragment _ VL_NOISE//노이즈
				//#pragma multi_compile_local_fragment _ VL_BLUENOISE//블루노이즈
                #pragma multi_compile_local_fragment VL_SPOT VL_SPOT_COOKIE VL_POINT VL_AREA_RECT VL_AREA_DISC//타입선택
                //#pragma multi_compile_local_fragment _ VL_SHADOWS VL_SHADOWS_TRANSLUCENCY VL_SHADOWS_CUBEMAP//쉐도우
                //#pragma multi_compile_local_fragment _ VL_CAST_DIRECT_LIGHT_ADDITIVE VL_CAST_DIRECT_LIGHT_BLEND
				#pragma multi_compile_local_fragment _ VL_PHYSICAL_ATTEN //빛 감쇠
				#pragma multi_compile _ _GBUFFER_NORMALS_OCT //z버퍼
