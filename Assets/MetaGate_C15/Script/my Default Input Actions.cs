...
//     version 1.3.0
//     from Assets/MetaGate_C15/Script/my Default Input Actions.inputactions
//
...
public partial class @MyDefaultInputActions : IInputActionCollection2, IDisposable
{
    ...
    public struct XRIRightHandInteractionActions
    {
        ...
        public void SetCallbacks(IXRIRightHandInteractionActions instance)
        {
            if (m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface != null)
            {
                ...
                @Move.started -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnMove;
            }
    ...
    private ICustromRightJoystick1DActions m_CustromRightJoystick1DActionsCallbackInterface;
    ...
    public struct CustromRightJoystick1DActions
    {
        ...
        {
            if (m_Wrapper.m_CustromRightJoystick1DActionsCallbackInterface != null)
            {
                @_1DMove.started -= m_Wrapper.m_CustromRightJoystick1DActionsCallbackInterface.On_1DMove;
                @_1DMove.performed -= m_Wrapper.m_CustromRightJoystick1DActionsCallbackInterface.On_1DMove;
                @_1DMove.canceled -= m_Wrapper.m_CustromRightJoystick1DActionsCallbackInterface.On_1DMove;
                @B.started -= m_Wrapper.m_CustromRightJoystick1DActionsCallbackInterface.OnB;
                @B.performed -= m_Wrapper.m_CustromRightJoystick1DActionsCallbackInterface.OnB;
                @B.canceled -= m_Wrapper.m_CustromRightJoystick1DActionsCallbackInterface.OnB;
                @A.started -= m_Wrapper.m_CustromRightJoystick1DActionsCallbackInterface.OnA;
                @A.performed -= m_Wrapper.m_CustromRightJoystick1DActionsCallbackInterface.OnA;
                @A.canceled -= m_Wrapper.m_CustromRightJoystick1DActionsCallbackInterface.OnA;
            }
            m_Wrapper.m_CustromRightJoystick1DActionsCallbackInterface = instance;
            if (instance != null)
            {
    ...
    private IMobileMoveActions m_MobileMoveActionsCallbackInterface;
    ...
    public struct MobileMoveActions
    {
        ...
        {
            if (m_Wrapper.m_MobileMoveActionsCallbackInterface != null)
            {
                @Move.started -= m_Wrapper.m_MobileMoveActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_MobileMoveActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_MobileMoveActionsCallbackInterface.OnMove;
                @Look.started -= m_Wrapper.m_MobileMoveActionsCallbackInterface.OnLook;
                @Look.performed -= m_Wrapper.m_MobileMoveActionsCallbackInterface.OnLook;
                @Look.canceled -= m_Wrapper.m_MobileMoveActionsCallbackInterface.OnLook;
                @Jump.started -= m_Wrapper.m_MobileMoveActionsCallbackInterface.OnJump;
                @Jump.performed -= m_Wrapper.m_MobileMoveActionsCallbackInterface.OnJump;
                @Jump.canceled -= m_Wrapper.m_MobileMoveActionsCallbackInterface.OnJump;
            }
            m_Wrapper.m_MobileMoveActionsCallbackInterface = instance;
            if (instance != null)
            {
                @Move.started += instance.OnMove;
                @Move.performed += instance.OnMove;
